...
struct CaffeineTrackingTip: Tip {
    ...
    var title: Text {
        Text("Track Caffeine Too")
    }

    var message: Text? {
        Text("Switch to Coffee or Tea to log caffeine alongside hydration.")
    }
...
struct StreakTip: Tip {
    ...
    var message: Text? {
        Text("Hit your daily goal to start a streak. Consistency is everything!")
    }
...
struct FavoriteDrinkTip: Tip {
    ...
    var message: Text? {
        Text("Long-press a drink button to save it as a favorite for quick access.")
    }
...
struct HistoryInsightTip: Tip {
    ...
    var message: Text? {
        Text("Swipe to the History tab to see your weekly and monthly trends.")
    }
...
struct ExportTip: Tip {
    ...
    var message: Text? {
        Text("Pro users can export hydration data as CSV for health tracking.")
    }
